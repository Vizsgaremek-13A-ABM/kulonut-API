...
Route::middleware(['auth:sanctum', 'verified', 'throttle:api', 'role.level:' . config('rbac.user_level')])->group(function () {
    ...
    Route::post('/users/{user}/profile-icon', [UserController::class, 'uploadProfileIcon'])->middleware('throttle:uploads');
});

Route::middleware(['auth:sanctum', 'verified', 'throttle:api', 'role.level:' . config('rbac.employee_level')])->group(function () {
...
Route::middleware(['auth:sanctum', 'verified', 'throttle:api', 'role.level:' . config('rbac.admin_level')])->group(function () {
